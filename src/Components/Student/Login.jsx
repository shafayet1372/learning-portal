...
export default function StudentLogin() {
    ...
    useEffect(() => {
        ...
        //if the user is authenticated  & role is student then redirect to the course-videos page with success message
        ...
        //if user is admin & try to login from the student login page then show the error message & dnt let login
    ...
    //remove the user from the local storage if the user is admin & try to login from the student login page
    useEffect(() => {
        if (removeUser) {
