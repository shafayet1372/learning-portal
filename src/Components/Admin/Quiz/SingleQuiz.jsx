...
import { useDeleteQuizeMutation } from '../../../features/api/quizeApi'
import { Link } from 'react-router-dom'
import Swal from 'sweetalert2'
export default function SingleQuiz({ data }) {
    const [deleteQuize, { isSuccess, isError }] = useDeleteQuizeMutation()
    ...
    useEffect(() => {
        if (isSuccess) {
            Swal.fire({
                text: "Quize deleted successfully",
                icon: "success",
            })
        }
